...
public class StatusLog {
    ...
    public StatusLog(GameScene manager){
        ...
        popup = new CObject(manager.master.view, "popup",
                SpriteBuildService.BuildModel("./data/costume/statuslog/popup.txt", "./data/costume/statuslog/popupfgcolor.txt", "./data/costume/statuslog/popupbgcolor.txt"),
                0, 0, false);
        ...
        popup.SetLocation(manager.master.view.getCameraX()+manager.master.view.getWidth()-popup.GetCostumeData().get(0).size()-1,
